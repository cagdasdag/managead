...
var adTitleList = ad_list['managead_ad_title'];
var selectData = [];
...
if (adTitleList) {
    ...
    registerBlockType('managead/block', {
        title: __('ManageAd', 'managead'),
        description: __('You can add your ad codes in content easily', 'managead'),
        icon: 'archive',
        category: 'widgets',
        attributes: {
            adKey: {
